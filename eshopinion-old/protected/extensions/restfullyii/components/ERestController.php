...
class ERestController extends GxController
{
  ...
  public function countRegistres($model, $nom){
      //metode per saber si hi ha registres no borrats de relacions
    $k = 0;
    foreach($model[$nom] as $value) { 
        if($value->deleted == 0){
            //si es vol borrar s'ha de carregar la relació i actualitzar a 1
            //$this->loadModel($traduccio_ip->id, 'InterespointIdioma')->delete();
            $k++; break;
        }
    }
    return $k;
 ...
 /**
  ...
  public function actionRestUpdate($id, $var=false)
  {
    ...
    {
      $var = 'doCustomRestPost' . ucfirst($var);
  ...
  {
    $this->renderJson(array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Records Retrieved Successfully', 'data'=>$this->getModel()->findAll()));
  }
  ...
  {
    $this->renderJson(array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Record Retrieved Successfully', 'data'=>$this->loadModel($id)));
  }
  ...
  {    
    ...
    $this->renderJson(array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Record Updated', 'data'=>array('id'=>$id)));
  }
  ...
  public function doRestCreate($data)
  {
    ...
    $this->renderJson(array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Record(s) Created', 'data'=>array('id'=>$ids)));
  }
  ...
  public function doRestDelete($id)
  {
    ...
    if($model->delete())
      $data = array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Record Deleted', 'data'=>array('id'=>$id));
    else
  ...
  public function doCustomRestGetLimit($var)
  {
    ...
    $this->renderJson(array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Records Retrieved Successfully', 'data'=>$this->getModel()->findAll($criteria)));
  }
  ...
  {
    $this->renderJson(array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Record Count Retrieved Successfully', 'data'=>array('count'=>count($this->getModel()->findAll()))));
  }
   ...
   * POST = {'id':'6', 'name':'evan'}
   */ 
  public function doCustomRestGetSearchdata($data)
  {
     print_r($_GET);die();
    $this->renderJson(array('success'=>true, 'timestamp'=>date("Y-m-d H:i:s"), 'message'=>'Records Retrieved Successfully', 'data'=>$this->getModel()->findAllByAttributes(array($_POST))));    
  }
  
        
  public function objectToArray($object){}
  
  //By timestamp i o User
  
    public function doCustomRestGetActivityBytimestamp($data){}

    public function doCustomRestGetActivityOptionBytimestamp($data){}

    public function doCustomRestGetActivityTypeBytimestamp($data){}

    public function doCustomRestGetAplicableLocationInfoTypeBytimestamp($data){}

    public function doCustomRestGetAppointmentsBytimestamp($data){}

    public function doCustomRestGetAssignedLabelBytimestamp($data){}

    public function doCustomRestGetCompanyAddressBytimestamp($data){}

    public function doCustomRestGetCompanyAudioBytimestamp($data){}

    public function doCustomRestGetCompanyContactBytimestamp($data){}
    
    public function doCustomRestGetUserBytimestamp($data){}

    public function doCustomRestGetCompanyById($data){}

    public function doCustomRestGetCompanyDocumentsBytimestamp($companyDocuments){}

    public function doCustomRestGetCompanyImageBytimestamp($data){}

    public function doCustomRestGetCompanyListBytimestamp($data){}
    
    public function doCustomRestGetLabelBytimestamp($data){}
    
    public function doCustomRestGetLocationInfoCategoryBytimestamp($data){}
     
    public function doCustomRestGetLocationInfoBytimestamp($data){}
    
    public function doCustomRestGetLocationInfoOptionBytimestamp($data){}
    
    public function doCustomRestGetLocationInfoTypeBytimestamp($data){}
    
    public function doCustomRestGetTodosBytimestamp($data){}
    
    public function doCustomRestGetToDoOwnerBytimestamp($data){}
    
    public function doCustomRestGetUserAssignedCompanyListBytimestamp($data){}
  
    public function doCustomRestGetCompanyBytimestamp($data){}
    
    public function doCustomRestGetLabelGroupBytimestamp($data){}
    
    public function doCustomRestGetActivityTypeGroupBytimestamp($data){}
    
    public function doCustomRestGetCountBytimestamp($data) {}
    
    public function doCustomRestGetOpportunitiesBytimestamp($opportunity){}
    
    public function doCustomRestGetOpportunityStageBytimestamp($opportunityStage){}
    
    public function doCustomRestGetActivityMSBytimestamp($activityOption){}
    
    public function doCustomRestGetAssignedLabelMSBytimestamp($alms){}
    
    public function doCustomRestGetAssignedLabelMSByAssignedLabelId($alms){}
    
    public function doCustomRestGetActivityMSByActivity($activityOption){}
    
    public function doCustomRestGetOpportunityFieldGroupBytimestamp($labelOption){}
    
    public function doCustomRestGetOpportunityFieldBytimestamp($data){}
    
    public function doCustomRestGetOpportunityOptionBytimestamp($activityOption){}
    
    public function doCustomRestGetAssignedOpportunityFieldBytimestamp($data) {}
    
    public function doCustomRestGetOpportunityMSByAssignedOpportunityFieldId($alms){}
    //By User

    public function doCustomRestGetAssignedLabelByuser($data){}
