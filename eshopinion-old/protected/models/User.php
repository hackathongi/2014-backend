...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, hours_to_email', 'numerical', 'integerOnly'=>true),
			array('name, email', 'length', 'max'=>255),
			array('address, url', 'length', 'max'=>512),
			...
			array('user_id, name, address, url, phone, email, logo_url, hours_to_email, username, password, token, data_add, date_update', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'configurations' => array(self::HAS_MANY, 'Configuration', 'user_id'),
			'customers' => array(self::HAS_MANY, 'Customers', 'user_id'),
		);
	}
